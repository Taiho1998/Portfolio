  ...
  return (
    <div className="group w-fit mx-auto relative">
      ...
      <img
        src="/Frame1.svg"
        alt="Profile_Img"
        className="size-[300px] -mt-[300px] mx-auto rounded-full group-hover:-translate-x-[150px] transition-[transform, box-shadow] duration-300 group-hover:shadow-[8px_8px_20px_rgba(0,0,0,0.25)]"
      />
    </div>
  );
}
